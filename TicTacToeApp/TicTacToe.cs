...
namespace TicTacToeApp
{
    public class TicTacToe : INotifyPropertyChanged
    {
        ...
        string messageval = "";
        PlayerEnum currentturnval = PlayerEnum.Blank;
        ...
        public void InvokePropertyChanged([CallerMemberName] string properytname = "")
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(properytname));
        }
        ...
        public void TakeSpot(int spotnum)
        {
            if (this.GameActive == true)
            {
                ...
                {
                    throw new Exception("There is no SPOT for the number " + spotnum.ToString());
                }
                if (Spots[spotnum].Value == PlayerEnum.Blank)
                {
                    ...
                    if (GameActive == true)
                    {
                        ...
                        if (this.PlayAgainstComputer == true && this.IsComputerTurn == true)
                        {
                            DoComputerMove();
                        }
                    }
        ...
        {
            this.Spots.ForEach(s => { s.Value = PlayerEnum.Blank; s.WinStatus = false; s.SpotColor = SpotDefaultColor; });
            this.CurrentTurn = PlayerEnum.X;
        ...
        {
            get { return currentturnval; }

            private set
            {
                currentturnval = value;
